        ...
        <div class="terms-scroll-block mb-3">
          ...
          >
            <div class="terms-scroll-content">
              ...
              <p><strong>Prohibido:</strong> Bots, trampas, colusión entre participantes o uso de la plataforma para actividades ilícitas. Los fondos para adquirir créditos deben ser de origen lícito. Nos reservamos el derecho de pedir KYC y de bloquear cuentas o retener créditos e incentivos si hay sospecha de fraude.</p>
              <p><strong>Edad y uso responsable:</strong> Solo mayores de 18 años (o mayoría de edad en tu país). Puedes solicitar cierre de cuenta (autoexclusión) en cualquier momento.</p>
              <p><strong>Responsabilidad:</strong> No nos hacemos responsables de fallos de conexión, cortes de luz o de terceros; la reconexión/bot no genera derecho a reembolso. Podemos anular créditos o incentivos por errores técnicos o «glitches». El abuso de promociones (colusión, chip-dumping, cuentas múltiples) implica revocación del incentivo y posible cierre de cuenta.</p>
