        ...
        <div class="terms-scroll-block mb-3">
          ...
          >
            <div class="terms-scroll-content">
              ...
              <p><strong>Responsabilidad:</strong> No nos hacemos responsables de fallos de conexión, cortes de luz o de terceros; la reconexión/bot no genera derecho a reembolso. Podemos anular saldos o ganancias por errores técnicos o «glitches». El abuso de bonos (colusión, chip-dumping, cuentas múltiples) implica revocación del bono y posible cierre de cuenta.</p>
