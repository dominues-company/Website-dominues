<template>
  <LegalPageLayout
    title="Política de Privacidad y Términos de Uso – Dominues"
...
<p>El acceso y uso de Dominues implica la aceptación total de estos términos. Si no estás de acuerdo, debes abandonar la plataforma de inmediato.</p>

<h2>2. Responsabilidad legal del usuario</h2>
<p>Dominues opera como plataforma tecnológica de entretenimiento basada en habilidades (Dominó). El usuario declara que el acceso es legal en su jurisdicción. Dominues no se hace responsable por violaciones a leyes locales o internacionales por parte de los usuarios.</p>
...
<h2>5. Prohibición de fraude y uso de bots</h2>
<p>Queda estrictamente prohibido el uso de software externo, bots o colusión entre jugadores. Cualquier actividad fraudulenta resultará en bloqueo permanente de la cuenta y confiscación de fondos sin derecho a reclamo.</p>

<h2>6. Seguridad y pasarelas de terceros</h2>
<p>Dominues utiliza pasarelas de terceros (como Cryptomus). No almacenamos claves privadas ni datos sensibles de tarjetas. Cualquier falla técnica ajena a nuestro servidor relacionada con dichas pasarelas es responsabilidad del proveedor.</p>

<h2>7. Limitación de responsabilidad</h2>
<p>Dominues no garantiza que la plataforma esté libre de errores técnicos o caídas de servidor externas. En caso de falla técnica durante una partida, el sistema buscará el restablecimiento, pero el usuario asume el riesgo inherente al juego en línea.</p>

<h2>8. Modificaciones</h2>
<p>Nos reservamos el derecho de modificar estos términos en cualquier momento. La continuación del uso tras dichos cambios constituye la aceptación de los mismos.</p>

<h2>9. Declaración de licitud de fondos y P2P</h2>
<p>El usuario declara que los fondos utilizados para cargar saldo (P2P/Pago Móvil o cripto) provienen de actividades lícitas y tienen procedencia legítima conforme a la legislación de Venezuela y estándares internacionales (GAFI).</p>

<h2>10. Deslinde de responsabilidad P2P</h2>
<p>En transacciones P2P: el titular de la cuenta bancaria o billetera debe coincidir con el titular de la cuenta en Dominues. Se prohíben pagos de terceros. El usuario garantiza que no utiliza la plataforma para triangulación de fondos u otras actividades ilícitas. Dominues se reserva el derecho de retener fondos de manera preventiva y solicitar documentación adicional (KYC) si detecta patrones inusuales.</p>
...
<p>El uso de Dominues está prohibido para menores de 18 años (o mayoría de edad legal en su país). El usuario puede solicitar cierre voluntario de cuenta (autoexclusión). Dominues no se hace responsable por las decisiones de apuesta del usuario; el juego es solo para entretenimiento.</p>

<h2>20. Propiedad intelectual</h2>
<p>Todo el software, gráficos, sonidos, logos y el nombre Dominues son propiedad exclusiva de la administración. Queda prohibida la reproducción, scraping o ingeniería inversa.</p>

<h2>21. Indemnidad del administrador</h2>
<p>El usuario se compromete a indemnizar a los propietarios y administradores de Dominues ante reclamos que surjan del mal uso de la plataforma o violación de estos términos.</p>

<h2>22. Un solo dispositivo y cuentas múltiples</h2>
<p>Se permite únicamente una (1) cuenta por persona, IP y dispositivo. Múltiples cuentas vinculadas para manipular bonos o colusión resultarán en suspensión y confiscación de saldo.</p>

<h2>23. Cancelación por sospecha</h2>
<p>Dominues se reserva el derecho de anular cualquier partida o transacción si existe sospecha razonable de fraude o violación de los términos.</p>

<h2>24. Ley aplicable y jurisdicción</h2>
<p>Para usuarios en Venezuela, estos términos se rigen por las leyes de la República Bolivariana de Venezuela. Para usuarios internacionales, se aplican principios del derecho mercantil internacional. Las disputas se resolverán mediante arbitraje privado designado por Dominues.</p>

<h2>25. Integridad del acuerdo</h2>
...
<h2>28. Mantenimiento y actualizaciones</h2>
<p>Dominues se reserva el derecho de interrumpir el acceso de forma temporal para mantenimiento o mejoras. Estas interrupciones no generan derecho a compensación.</p>
...
<p><strong>30.5 Cuentas de pensionados.</strong> Los retiros solicitados a cuentas de pensionados tienen limitaciones bancarias para recibir dinero y pueden ser devueltas por los bancos. Se recomienda usar cuentas normales para tales fines.</p>
